...
//
// Uses Resend's own built-in "onboarding@resend.dev" sender address, which works immediately
// with no domain setup needed - swap this for your own domain's email once you have one, but
// this works right now without any domain at all.
...
export default async function handler(req, res) {
  ...
  try {
    const response = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'SalesPilot <onboarding@resend.dev>', // works with no domain setup - update once you have your own domain email
        to: [email],
